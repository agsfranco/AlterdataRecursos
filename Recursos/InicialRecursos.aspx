...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            <asp:UpdatePanel ID="UpdatePanelRecursos" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
                <ContentTemplate>
                    <h1>Recursos</h1>
    ...
    <br/><br/>  
    <asp:UpdatePanel ID="UpdatePanelVotarRecurso" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
        <ContentTemplate>
            <asp:Panel ID="PanelVotarRecurso" runat="server" Visible="False" >
                ...
                <asp:TextBox ID="tbComentarioVoto" runat="server" Height="90px" MaxLength="500" Rows="10" TextMode="MultiLine" Width="600px" CausesValidation="True" ClientIDMode="Static"></asp:TextBox>
                <h3>
            ...
            <asp:HiddenField ID="HfDateTimeCliente" runat="server" ClientIDMode="Static" />
        </ContentTemplate>
    </asp:UpdatePanel>    
    <asp:UpdatePanel ID="UpdatePanelVotações" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
        <ContentTemplate>
